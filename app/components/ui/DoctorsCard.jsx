...
export default function DoctorsCard() {
  return (
    <div className="overflow-hidden rounded-3xl flex flex-col border border-border shadow-md hover:-translate-y-1 duration-150 group">
      <div className=" overflow-hidden ">
        <Image
          src={Hero}
          alt="doctor1"
          className="w-full max-h-96 md:max-h-64 object-cover object-center group-hover:scale-105 duration-300"
        />
      </div>
